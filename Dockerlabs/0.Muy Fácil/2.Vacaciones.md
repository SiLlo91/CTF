...
![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/117.png)
...
-
![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/118.png)
...
- **Navegación web:** Se visita el sitio en `http://172.17.0.2.
    Tenemos una página en blanco
     ...
     ![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/119.png)
- **Análisis del código fuente:** Se revisa el HTML en busca de comentarios, rutas o scripts ocultos.
    Encontramos los nombres de dos posibles usuarios:
	    `Juan` y `Camilo`
	![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/120.png)
...
```
![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/121.png)
**Hallazgos:**
...
![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/122.png)
...
![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/123.png)
...
![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/124.png)
...
`id`
 ![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/125.png)
 
 
¿Qué usuario hay en el sistema?
`cd home` y `ls` 

![](CTF/Dockerlabs/0.Muy%20Fácil/Imagenes/126.png)
