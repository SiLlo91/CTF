...
#### Comprobación subida de archivos:
  ...
  1. Generamos una Reverse shell en   https://www.revshells.com/ y guardamos este código en un archivo que llamamos `revershell.php` y lo subimos desde `/panel`
     ![](7.png)
...
4.  Modificamos la extensión por otra compatible por php en este caso `.php5` y subimos el archivo. 
...
![](10.png)
	Subimos el archivo con éxito
	  ![](11.png)  De este modo si nos acepta el archivo. 
...
Teneidno el archivo `revershell.php5` subido al servidor vamos a ejecutarlo siguiendo estos pasos:
...
- Vamos al directorio web `/uploads/` y hacemos click sobre el archivo que hemos subido `revershell.php5`
  ![](13.png)
