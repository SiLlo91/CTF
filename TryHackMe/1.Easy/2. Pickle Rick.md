...
- **Navegación web:** Se visita el sitio en `http://10.10.243.209.
    Tenemos esta página donde Rick nos pide que encontremos 3 ingredientes para elaborar una poción y dejar de ser un pepinillo. que serán nuestras flags
       ![](Imagenes/27.png)
...
3. Teniendo el puerto en escucha, ejecutamos el código en la terminal. Dándonos el acceso inicial en nuestra Kali.  
   ![](Imagenes/35.png)![](Imagenes/36.png)
